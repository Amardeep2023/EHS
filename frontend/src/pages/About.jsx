      ...
      <section className="py-28 px-6">
        <div className="max-w-7xl mx-auto">
          <div className="grid md:grid-cols-2 gap-8 mb-20">
            <AnimSection>
              <div className="p-12 rounded-luxury bg-espresso text-cream">
            ...
            <AnimSection>
              <div className="p-12 rounded-luxury luxury-border bg-white/60">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            {values.map((v, i) => (
              ...
              >
                ...
                <p className="text-sm text-secondary leading-relaxed">{v.text}</p>
              </motion.div>
            ))}
          </div>
        </div>
