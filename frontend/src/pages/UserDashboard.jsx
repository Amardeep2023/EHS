              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                {courses.map((course, idx) => (
                  ...
                  >
                    ...
                    {/* Course Info */}
                    <div className="p-6">
                      <h3 className="font-boska italic text-xl text-espresso mb-2 line-clamp-2" style={{ fontFamily: 'Boska, Georgia, serif' }}>
                        {course.title}
                      </h3>
                      <p className="text-secondary text-sm mb-4">Price: ${course.price}</p>

                      {/* Continue Learning Button */}
                      <button className="w-full flex items-center justify-center gap-2 bg-gold text-espresso py-3 rounded-full font-medium hover:bg-cream transition-all duration-300 group/btn">
                        Continue Learning
