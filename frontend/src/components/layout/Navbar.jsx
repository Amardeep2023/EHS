      ...
      >
        <div className="max-w-7xl mx-auto px-6 h-full flex items-center justify-between">
          ...
          <Link to="/" className="flex items-center gap-3 group">
            <div className="w-12 h-12 rounded-full overflow-hidden border-2 border-[#4B6A4A] group-hover:border-[#D47E5A] transition-colors shadow-sm bg-white flex items-center justify-center">
              <img 
                src="/assets/logo.jpg" 
